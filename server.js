...
app.get('/api/wordbyword/:token/:surah/:ayah', async (req, res) => {
  try {
    ...
    const response = await axios.get(
      ...
      `https://apis.quran.foundation/content/api/v4/verses/by_key/${verseKey}?words=true&translations=131&word_translation_language=ta&fields=text_uthmani&word_fields=verse_key,text_uthmani&translation_fields=resource_name,language_id&mushaf=2`,
      {
        headers: {
